...
namespace CatalogService.Tests.UnitTests
{
    public class ProductServiceUnitTests
    {
        ...
        public ProductServiceUnitTests() 
        {
            ...
            _mockProductValidator.Setup(v => v.ValidateAsync(It.IsAny<Product>(), It.IsAny<CancellationToken>()))
        ...
        public async Task CreateProductAsync_ValidRequest_CreatesProduct()
        {
            ...
            _mockRepository.Setup(repo => repo.CreateAsync(It.IsAny<Product>(), It.IsAny<CancellationToken>()))
            ...
            //Assert
            _mockRepository.Verify(repo => repo.CreateAsync(createdProduct, CancellationToken.None), Times.Once());
            _mockProductValidator.Verify(v => v.ValidateAsync(createdProduct, CancellationToken.None), Times.Once());
        }
        ...
        public async Task UpdateProduct_ValidRequestWithAllProperties_UpdatesProduct()
        {
            ...
            _mockRepository.Setup(repo => repo.UpdateAsync(id, It.IsAny<Product>(), It.IsAny<CancellationToken>()))
            ...
            _mockRepository.Verify(repo => repo.GetByIdAsync(id, CancellationToken.None), Times.Once());
            _mockRepository.Verify(repo => repo.UpdateAsync(id, updatedProduct, CancellationToken.None), Times.Once());
            _mockProductValidator.Verify(validator => validator.ValidateAsync(It.Is<Product>(p => p.Name == updateRequest.Name && p.Price == updateRequest.Price), It.IsAny<CancellationToken>()), Times.Once());
        }
        ...
        public async Task UpdateProduct_ValidRequestWithOneProperty_UpdatesProduct()
        {
            ...
            _mockRepository.Verify(repo => repo.GetByIdAsync(id, CancellationToken.None), Times.Once());
            _mockRepository.Verify(repo => repo.UpdateAsync(id, updatedProduct, CancellationToken.None), Times.Once());          
            _mockProductValidator.Verify(validator => validator.ValidateAsync(updatedProduct, CancellationToken.None));
        }
        ...
        public async Task UpdateProduct_InvalidRequest_ThrowsValidationException()
        {
            ...
            _mockRepository.Verify(repo => repo.GetByIdAsync(id, CancellationToken.None), Times.Never());
            _mockRepository.Verify(repo => repo.UpdateAsync(It.IsAny<Guid>(), It.IsAny<Product>(), It.IsAny<CancellationToken>()), Times.Never());
        ...
        public async Task UpdateProductQuantity_ValidRequest_UpdateQuantity()
        {
            ...
            _mockRepository.Verify(repo => repo.GetByIdAsync(id, CancellationToken.None), Times.Once());
            _mockRepository.Verify(repo => repo.UpdateAsync(id, productToUpdate, CancellationToken.None), Times.Once());
        }
        ...
        public async Task UpdateProductQuantity_InsufficientQuantity_ThrowsValidationException()
        {
            ...
            _mockRepository.Verify(repo => repo.GetByIdAsync(id, CancellationToken.None), Times.Once());
            _mockRepository.Verify(repo => repo.UpdateAsync(id, It.IsAny<Product>(), It.IsAny<CancellationToken>()), Times.Never());         
        }
        ...
        public async Task DeleteProduct_ValidId_DeleteProduct()
        {
            ...
            _mockRepository.Verify(repo => repo.GetByIdAsync(id, CancellationToken.None), Times.Once());
            _mockRepository.Verify(repo => repo.DeleteAsync(productToDelete, CancellationToken.None), Times.Once());
        }
        ...
        public async Task DeleteProduct_NotFoundId_ThrowsNotFoundEcxeption()
        {
            ...
            _mockRepository.Verify(repo => repo.DeleteAsync(It.Is<Product>(p => p.Id == id), It.IsAny<CancellationToken>()), Times.Never());
        }
    }
